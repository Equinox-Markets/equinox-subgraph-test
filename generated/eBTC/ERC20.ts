...
export class ERC20__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ERC20 extends ethereum.SmartContract {
  ...
  getAccountSnapshot(account: Address): ERC20__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new ERC20__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<ERC20__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new ERC20__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
